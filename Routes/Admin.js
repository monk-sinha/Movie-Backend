...
const errorHandle = require('../Middleware/errorMid');
const adminTokenHandle = require('../Middleware/checkAdminToken');
...
router.get('/checklogin', adminTokenHandle, async (req, res) => {
    res.json({
        adminId: req.adminId,
        ok: true,
